...
import { ALGOLEDGER_MESSAGE_SOURCE, type AcceptedSubmissionMessage } from '../src/types/messages'
...
export const acceptedSubmissionMessage: AcceptedSubmissionMessage = {
